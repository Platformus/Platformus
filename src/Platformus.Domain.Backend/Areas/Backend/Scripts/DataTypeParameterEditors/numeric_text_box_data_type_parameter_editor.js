...
(function (platformus) {
  ...
  platformus.dataTypeParameterEditors.numericTextBox = {};
  platformus.dataTypeParameterEditors.numericTextBox.create = function (container, dataTypeParameter) {
  ...
  function createField(dataTypeParameter) {
    ...
    platformus.controls.numericTextBox.create({ identity: identity, value: dataTypeParameter.value }).appendTo(field);
