...
namespace Platformus.Core.Backend
{
  public class DateFieldTagHelper : TagHelper
  {
    ...
    public override void Process(TagHelperContext context, TagHelperOutput output)
    {
      ...
      output.Attributes.SetAttribute(AttributeNames.Class, "date-editor form__field field" + (string.IsNullOrEmpty(this.Class) ? null : $" {this.Class}"));
    ...
    private TagBuilder CreateTextBox()
    {
      ...
      TagBuilder tb = TextBoxGenerator.Generate(
        ...
        InputTypes.Text,
        value == null ? null : ((DateTime)value).ToFixedLengthDateString(),
