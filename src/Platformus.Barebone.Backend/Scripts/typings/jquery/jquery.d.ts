...
interface JQueryStatic {
     ...
     * @param context DOM element to serve as the context in which the HTML property will be created
...
interface JQuery {
    ...
    */
     ...
     * Add elements to the set of matched elements.
     * 
     * @param html An HTML property to add to the set of matched elements.
     */
