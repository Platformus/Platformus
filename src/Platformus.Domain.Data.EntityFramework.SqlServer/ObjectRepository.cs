...
namespace Platformus.Domain.Data.EntityFramework.SqlServer
{
  ...
  /// for manipulating the <see cref="Object"/> entities in the context of SQL Server database.
  /// </summary>
  public class ObjectRepository : RepositoryBase<Object>, IObjectRepository
  {
    ...
    {
      return this.dbSet.AsNoTracking().Where(o => o.ClassId == classId);
    }
    ...
    public void Delete(Object @object)
    {
      this.storageContext.Database.ExecuteSqlCommand(
        @"
          ...
          INSERT INTO #Dictionaries SELECT StringValueId FROM Properties WHERE ObjectId = {0} AND StringValueId IS NOT NULL;
