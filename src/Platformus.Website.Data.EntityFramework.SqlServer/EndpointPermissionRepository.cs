...
namespace Platformus.Website.Data.EntityFramework.SqlServer
{
  /// <summary>
  /// Implements the <see cref="IEndpointPermissionRepository"/> interface and represents the repository
  /// for manipulating the <see cref="EndpointPermission"/> entities in the context of SQL Server database.
  /// </summary>
