...
gulp.task(
  "backend:minify-css", function (cb) {
    return gulp.src(paths.backend.scss.dest + "/*.css")
      .pipe(minifyCss())
      .pipe(autoprefixer())
      .pipe(concat("platformus.static.min.css.temp"))
      .pipe(gulp.dest(paths.backend.scss.dest));
  }
);
...
gulp.task(
  "backend:minify-js", function (cb) {
    return gulp.src(
        [
          paths.backend.ts.dest + "/platformus.overlays.fileselectorform.js",
          paths.backend.ts.dest + "/platformus.ui.js",
          paths.backend.ts.dest + "/*.js"
        ]
      )
      .pipe(uglify())
      .pipe(concat("platformus.static.min.js.temp"))
      .pipe(gulp.dest(paths.backend.ts.dest));
  }
);
...
gulp.task(
  "backend:rename-temp-minified-css", function (cb) {
    return gulp.src(paths.backend.scss.dest + "/platformus.static.min.css.temp")
      .pipe(rename("platformus.static.min.css"))
      .pipe(gulp.dest(paths.backend.scss.dest));
  }
);
...
gulp.task(
  "backend:rename-temp-minified-js", function (cb) {
    return gulp.src(paths.backend.ts.dest + "/platformus.static.min.js.temp")
      .pipe(rename("platformus.static.min.js"))
      .pipe(gulp.dest(paths.backend.ts.dest));
  }
);
