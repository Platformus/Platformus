...
namespace Platformus.Domain.Data.EntityFramework.PostgreSql
{
  public class ClassRepository : RepositoryBase<Class>, IClassRepository
  {
    ...
    {
      if (classId == null)
        return this.dbSet.FromSql("SELECT * FROM \"Classes\" WHERE \"Id\" NOT IN (SELECT \"ClassId\" FROM \"Members\" WHERE \"IsRelationSingleParent\" IS NOT NULL) AND \"ClassId\" IS NULL AND \"IsAbstract\" IS NULL ORDER BY \"Name\"", classId);
