...
namespace Platformus.ECommerce.Data.EntityFramework.SqlServer
{
  ...
  /// for manipulating the <see cref="Category"/> entities in the context of SQL Server database.
  /// </summary>
    ...
    public void Delete(Category category)
    {
      this.storageContext.Database.ExecuteSqlCommand(
        @"
          ...
          INSERT INTO #Dictionaries SELECT NameId FROM Categories WHERE Id IN (SELECT Id FROM #Categories);
